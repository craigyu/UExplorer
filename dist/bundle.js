  ...
  var QueryBuilder = function (_React$Component) {
    ...
    _createClass(QueryBuilder, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement('div', { className: 'queryBuilder ' + schema.classNames.queryBuilder }, _react2.default.createElement(_RuleGroup2.default, {
          rules: rules,
  ...
  var Rule = function (_React$Component) {
    ...
    _createClass(Rule, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement('div', { className: 'rule ' + classNames.rule }, _react2.default.createElement(controls.fieldSelector, {
          options: fields,
          value: field,
  ...
  var RuleGroup = function (_React$Component) {
    ...
    _createClass(RuleGroup, [{
      ...
      value: function render() {
        ...
        var level = getLevel(this.props.id);
        return _react2.default.createElement('div', { className: 'ruleGroup ' + classNames.ruleGroup }, _react2.default.createElement(controls.combinatorSelector, {
          options: combinators,
          value: combinator,
  ...
  var ActionElement = function (_React$Component) {
    ...
    _createClass(ActionElement, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement('button', { className: className,
  ...
  var ValueSelector = function (_React$Component) {
    ...
    _createClass(ValueSelector, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement('select', { className: className,
          value: value,
          onChange: function onChange(e) {
            return handleOnChange(e.target.value);
          } }, options.map(function (option) {
          return _react2.default.createElement('option', { key: option.name, value: option.name }, option.label);
        }));
      }
    }], [{
      key: 'propTypes',
...
/***/function (module, exports, __webpack_require__) {
  ...
  var _Symbol3 = __webpack_require__(11);
...
/***/function (module, exports, __webpack_require__) {
  ...
  var _Symbol4 = __webpack_require__(11);
...
exports.Query = exports.operators = exports.combinators = exports.fields = undefined;
...
var _reactQuerybuilder = __webpack_require__(1);

var _reactQuerybuilder2 = _interopRequireDefault(_reactQuerybuilder);
...
var fields = exports.fields = [{ name: 'firstName', label: 'First Name' }, { name: 'lastName', label: 'Last Name' }, { name: 'age', label: 'Age' }, { name: 'address', label: 'Address' }, { name: 'phone', label: 'Phone' }, { name: 'email', label: 'Email' }, { name: 'twitter', label: 'Twitter' }, { name: 'isDev', label: 'Is a Developer?', value: false }];

var combinators = exports.combinators = [{ name: 'WHERE', label: 'Where' }, { name: 'OPTIONS', label: 'Options' }, { name: 'TRANSFORMATION', label: 'Transformation' }];
var operators = exports.operators = [{ name: 'AND', label: 'And' }, { name: 'OR', label: 'Or' }, { name: 'IS', label: 'is' }, { name: 'GT', label: '>' }, { name: 'LT', label: '<' }, { name: 'EQ', label: '=' }];

var Query = exports.Query = function (_React$Component) {
...
var _Querybuilder = __webpack_require__(4);
...
render(React.createElement(_Querybuilder.Query, { fields: _Querybuilder.fields, combinators: _Querybuilder.combinators, operators: _Querybuilder.operators }), document.querySelector('.container'));
